				...
				<div class="card shadow">
						<div class="card-header">
								...
								<div class="row">
									...
									<div class="col-xl-4">
										<div id="barcode-{!! $itemInfo[0]->inventory_id !!}" value="{!! "toPrint-" . $itemInfo->inventory_id!!}">
								...
								<div class="col-md-6 mb-3">
										...
										<select id="subcategory" name="subcategory" class="form-control" placeholder="Sub-Category" required>
												...
												@foreach ($subcategories as $subcategory)
													@if ($subcategory->subcategory == $itemInfo[0]->subcategory)
														<option value="{{ $subcategory->category_no }}" id="categoryBal" selected>{{ $subcategory->subcategory_name }}</option>
													@else
														<option value="{{ $subcategory->category_no }}" id="categoryBal" >{{ $subcategory->subcategory_name }}</option>
													@endif
												@endforeach 
										</select>
										{{ Form::hidden('categoryVal', $itemInfo[0]->category, ['class' => 'form-control', 'placeholder' => 'Category'] )}}
